...
const { sendApplicationStatusUpdateEmail } = require("../services/emailService"); // adjust path if needed
...
exports.applyForJob = async (req, res) => {
  try {
    ...
    if (!job || job.statusId !== 2) { // Assuming 2 = Open
